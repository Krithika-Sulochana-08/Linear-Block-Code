...
```
# Output Waveform
<img width="681" height="657" alt="image" src="https://github.com/user-attachments/assets/23674a79-9b07-4578-a2ff-c6b75f161469" />

<img width="634" height="637" alt="image" src="https://github.com/user-attachments/assets/ba5b234e-5922-47dd-8a14-f4119a5b08bb" />


# Results
```
Thus,a Matrix, Codeword, Hamming weight, Syndrome matrix was generated, and the error on received codeword was found using Linear block code.
```
